...
@IonicPage()
@Component({
  selector: 'page-commandes-ajout-produit',
  templateUrl: 'commandes-ajout-produit.html',
})
export class CommandesAjoutProduitPage {
...
getOrdreProd($nbon){
  ...
  ajouterdetails ($prod_aj) {
    if($prod_aj.d_prod == null){
      let alert = this.alertCtrl.create({
        title: "Information",
        subTitle: "Veuillez saisir un produit à ajouter à la commande !",
        buttons: ['OK']
      });
      alert.present();
